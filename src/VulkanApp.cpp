...
VulkanApp::VulkanApp(const int width, const int height) {
    this->width = width;
    this->height = height;
    window = nullptr;
...
void VulkanApp::createTextureImage() {
    ...
    stbi_uc *pixels = stbi_load("textures/cabblestone.png", &width, &height, &channels, STBI_rgb_alpha);
...
void
VulkanApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
